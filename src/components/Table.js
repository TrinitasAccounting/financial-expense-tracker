...
//Need to pass down the transactions properties
// function test(props) {
...
///THIS IS WHERE THE DATA IS ACTUAL RENDERED SO THE MATERIAL UI CAN DO ITS THING
// const rows = [
//     { "id": 14, "date": '3/2/2023', "description": "Shell Gas", "category": "Gas & Fuel", "amount": 55.77 },
//     { "id": 15, "date": '2/25/2023', "description": "Exxon Gas", "category": "Meals & Entertainment", "amount": 99999.77 },
//     createData(17, "3/2/2022", "BP Gas", "Job Supplies", 8888888888.2222),
...
export default function EnhancedTable(props) {
    ...
    // const testArray = props.trans.map((tran) => {
    //     return (
    //         // createData(tran.id, tran.description, tran.description, tran.category, tran.amount)
    //         rows.push(createData(tran.id, tran.description, tran.description, tran.category, tran.amount))
    //     )
    // })
    ...
    //trying to check if the rendering is updating state?
    // if(rerenderingTransactions !== testArray) {
    //     return "they do not "
    // }
    ...
    return (
        <Box sx={{ width: '100%', paddingLeft: "260px", paddingRight: '20px', paddingTop: '150px' }}>
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {/* <SelectDropDown align="right"
                                            categ={props.categ}
                                            categorySelection={props.categorySelection}
                                            transId={rows.id}
                                        >{row.category}</SelectDropDown> */}
